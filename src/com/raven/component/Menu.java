...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("icons8-dashboard-25", "Home", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("icons8-drop-counter-25", "Blood Sugar Tracking", Model_Menu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#000080"), 0, getHeight(), Color.decode("#000080"));
        g2.setPaint(g);
